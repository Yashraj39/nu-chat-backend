...
public class MessageService {
 ...
 private Message.FileInfo normalizeExternalFile(Message.FileInfo file) {
   // Google Drive files are already stored remotely. Never re-import them into Cloudinary.
   if(file.getDriveFileId() != null && !file.getDriveFileId().isBlank()) return file;
