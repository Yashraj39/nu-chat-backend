...
class MessageServiceTest {
 @Test void ownMessageCanBeDeleted(){
   ...
   var s=new MessageService(r,m,l,c,30); User u=User.builder().id("u1").role(Role.USER).build();
 ...
 @Test void otherUserCannotDelete(){
   ...
   var s=new MessageService(r,m,l,c,30); User u=User.builder().id("other").role(Role.USER).build();
