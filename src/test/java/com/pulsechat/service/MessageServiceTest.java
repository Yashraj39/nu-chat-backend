...
class MessageServiceTest {
 @Test void ownMessageCanBeDeleted(){
   MessageRepository r=mock(MessageRepository.class); MongoTemplate m=mock(MongoTemplate.class); RateLimiter l=mock(RateLimiter.class);
   ...
   var s=new MessageService(r,m,l); User u=User.builder().id("u1").role(Role.USER).build();
 ...
 @Test void otherUserCannotDelete(){
   ...
   var s=new MessageService(r,m,l); User u=User.builder().id("other").role(Role.USER).build();
